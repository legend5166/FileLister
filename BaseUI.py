...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Sat Mar  1 11:09:30 2025
#
...
class FileListBaseUIFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: FileListBaseUIFrame.__init__
		...
		label_folder = wx.StaticText(self.panel_1, wx.ID_ANY, u"目标文件夹(&P)")
		sizer_1_h.Add(label_folder, 0, 0, 0)

		self.tc_folder_path = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
		sizer_1_h.Add(self.tc_folder_path, 0, 0, 0)

		self.btn_browse = wx.Button(self.panel_1, wx.ID_ANY, u"浏览(&B)")
		sizer_1_h.Add(self.btn_browse, 0, 0, 0)

		sizer_2_h = wx.BoxSizer(wx.HORIZONTAL)
		sizer_v_1.Add(sizer_2_h, 1, wx.EXPAND, 0)

		self.rb_priority = wx.RadioBox(self.panel_1, wx.ID_ANY, u"文件顺序(&O)", choices=[u"根目录文件在前", u"子文件夹文件在前", u"仅根目录的文件"], majorDimension=3, style=wx.RA_SPECIFY_COLS)
		self.rb_priority.SetSelection(0)
		sizer_2_h.Add(self.rb_priority, 0, 0, 0)
		...
		self.rb_filename = wx.RadioBox(self.panel_1, wx.ID_ANY, u"文件名显示(&T)", choices=[u"仅文件名", u"相对路径", u"绝对路径"], majorDimension=1, style=wx.RA_SPECIFY_ROWS)
		self.rb_filename.SetSelection(0)
		sizer_3_h.Add(self.rb_filename, 0, 0, 0)
		...
		self.rb_file_type = wx.RadioBox(self.panel_1, wx.ID_ANY, u"文件类型", choices=[u"指定的文件类型", u"排除的文件类型"], majorDimension=1, style=wx.RA_SPECIFY_ROWS)
		self.rb_file_type.SetSelection(0)
		sizer_4_h.Add(self.rb_file_type, 1, 0, 0)
		...
		self.lb_file_type = wx.StaticText(self.panel_1, wx.ID_ANY, u"指定的文件类型[留空包含所有类型](&T)")
		sizer_1_v.Add(self.lb_file_type, 0, 0, 0)

		self.tc_file_type = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
		sizer_1_v.Add(self.tc_file_type, 0, 0, 0)

		sizer_5h = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, u"文件属性"), wx.HORIZONTAL)
		sizer_v_1.Add(sizer_5h, 1, wx.EXPAND, 0)

		self.checkbox_size = wx.CheckBox(self.panel_1, wx.ID_ANY, u"大小")
		sizer_5h.Add(self.checkbox_size, 0, 0, 0)

		self.checkbox_create = wx.CheckBox(self.panel_1, wx.ID_ANY, u"创建时间")
		sizer_5h.Add(self.checkbox_create, 0, 0, 0)

		self.checkbox_modify = wx.CheckBox(self.panel_1, wx.ID_ANY, u"修改时间")
		sizer_5h.Add(self.checkbox_modify, 0, 0, 0)

		self.checkbox_access = wx.CheckBox(self.panel_1, wx.ID_ANY, u"访问时间")
		sizer_5h.Add(self.checkbox_access, 0, 0, 0)

		sizer_btn_h = wx.BoxSizer(wx.HORIZONTAL)
		sizer_v_1.Add(sizer_btn_h, 0, wx.ALL, 4)

		self.button_OK = wx.Button(self.panel_1, wx.ID_ANY, u"生成清单(&G)")
		self.button_OK.SetDefault()
		sizer_btn_h.Add(self.button_OK, 0, 0, 0)

		self.button_CANCEL = wx.Button(self.panel_1, wx.ID_ANY, u"关闭(&C)")
		sizer_btn_h.Add(self.button_CANCEL, 0, 0, 0)

		sizer_v_2 = wx.BoxSizer(wx.VERTICAL)
		sizer_h.Add(sizer_v_2, 1, wx.ALL | wx.EXPAND, 5)

		self.folder_tree = wx.TreeCtrl(self.panel_1, wx.ID_ANY)
		sizer_v_2.Add(self.folder_tree, 1, wx.EXPAND, 0)

		self.panel_1.SetSizer(sizer_h)
		...
		self.Bind(wx.EVT_RADIOBOX, self.OnFileTypeRb, self.rb_file_type)
		self.Bind(wx.EVT_BUTTON, self.OnGenerateFilelistBtn, self.button_OK)
		self.Bind(wx.EVT_BUTTON, self.OnCloseBTN, self.button_CANCEL)
		# end wxGlade

	def OnBrowseBtn(self, event):  # wxGlade: FileListBaseUIFrame.<event_handler>
		print("Event handler 'OnBrowseBtn' not implemented!")
		event.Skip()

	def OnPriorityRB(self, event):  # wxGlade: FileListBaseUIFrame.<event_handler>
		print("Event handler 'OnPriorityRB' not implemented!")
		event.Skip()

	def OnFileTypeRb(self, event):  # wxGlade: FileListBaseUIFrame.<event_handler>
		print("Event handler 'OnFileTypeRb' not implemented!")
		event.Skip()

	def OnGenerateFilelistBtn(self, event):  # wxGlade: FileListBaseUIFrame.<event_handler>
		print("Event handler 'OnGenerateFilelistBtn' not implemented!")
		event.Skip()

	def OnCloseBTN(self, event):  # wxGlade: FileListBaseUIFrame.<event_handler>
		print("Event handler 'OnCloseBTN' not implemented!")
		event.Skip()

# end of class FileListBaseUIFrame
